...
public class SampleDataGenerator : MonoBehaviour
{
    ...
    private void Start()
    {
        m_HealthDataProvider = new DataProvider(Color.red, "Health", "hp");
        m_StaminaDataProvider = new DataProvider(Color.green, "Stamina", "stamina");
        m_ManaDataProvider = new DataProvider(Color.magenta, "Mana", "mana");
        m_ExperienceDataProvider = new DataProvider(Color.blue, "Experience", "xp");
